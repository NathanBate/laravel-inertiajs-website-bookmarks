...
Route::middleware('guest')->group(function () {
    ...
    Route::get('verify-profile-email/{user}/{hash}', [UsersController::class, 'profileVerifyEmail'])
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('denied-approval', function () {
        return Inertia::render('Auth/DeniedApproval');
...
Route::middleware(['auth','verified','profile.approved','edit.user.profile.only'])->group(function () {
    ...
    // User Profile
    Route::get('profile/{user}/edit', [UsersController::class, 'profileEdit'])
        ->name('profile.edit');
...
Route::middleware(['auth','verified','profile.approved','admin.role'])->group(function () {
    ...
    Route::get('user/{user}/edit', [UsersController::class, 'edit'])
        ->name('user.edit')
        ->middleware('no.touch.super');
    Route::post('user/{user}/update', [UsersController::class, 'update'])
        ->name('user.update')
        ->middleware('no.touch.super');
    Route::get('user/{user}/send-password-reset-email',[UsersController::class, 'sendPasswordResetEmail'])
        ->middleware('no.touch.super');
